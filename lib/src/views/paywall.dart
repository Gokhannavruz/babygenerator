...
class _PaywallState extends State<Paywall> {
                ...
                child: Column(
                  children: [
                    _buildFeatureRow('Unlimited Baby Appearance Prediction',
                        Icons.child_care),
                    _buildFeatureRow(
                        'Unlimited Baby Name Generation', Icons.face),
                    _buildFeatureRow(
  ...
  void _subscribeNow() async {
    try {
      ...
      if (appData.entitlementIsActive && mounted) {
        // Başarılı satın alma sonrası UI güncellemesi
        ...
        // Paywall'ı kapat ve ana sayfayı yenile
        Navigator.of(context)
            .pop(true); // true döndürerek başarılı işlemi bildir
      }
    } catch (e) {
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
